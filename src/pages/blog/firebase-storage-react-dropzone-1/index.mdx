...
import cover from './cover-1-800-400.jpg'
import createWebApp from './firebase-create-web-app.png'
import menuStorage from './firebase-menu-storage.png'
import rules from './firebase-rules.png'
...
There is no point in building everything from scratch. Basically, _don't reinvent the wheel_.
...
<Image src={createWebApp} alt="Easy Image Uploads with Firebase Storage and React Dropzone" />
