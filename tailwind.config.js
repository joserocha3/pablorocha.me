    ...
    typography: (theme) => ({
      invert: {
        css: {
          ...
          '--tw-prose-h3': 'var(--tw-prose-invert-h3)',
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-h3': theme('colors.zinc.600'),
          ...
          '--tw-prose-code-bg': theme('colors.zinc.400 / 0.2'),
          ...
          '--tw-prose-invert-headings': theme('colors.pink.400'),
          '--tw-prose-invert-h3': theme('colors.zinc.300'),
          '--tw-prose-invert-links': theme('colors.sky.300'),
          '--tw-prose-invert-links-hover': theme('colors.sky.300'),
          '--tw-prose-invert-underline': theme('colors.sky.300 / 0.3'),
          '--tw-prose-invert-underline-hover': theme('colors.sky.300'),
          ...
          '--tw-prose-invert-code-bg': theme('colors.zinc.100 / 0.05'),
